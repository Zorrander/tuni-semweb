    ...
    QObject(parent)
{
    ...
    m_actionlist = QStringList() << "Give" << "Home" << "Open" << "Close" << "Pick" << "Place" << "Reach" << "Grasp";
    m_targetlist = QStringList() << "Storage" << "Handover" << "Peg" << "Separator" << "Common rail" << "Piston" << "Tappet" << "Bolt1" << "Bolt2" << "Tool" << "PLC";
}
